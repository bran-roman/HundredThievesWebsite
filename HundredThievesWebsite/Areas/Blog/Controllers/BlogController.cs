...
using HundredThievesWebsite.Areas.Blog.Models;
using HundredThievesWebsite.Data;

namespace HundredThievesWebsite.Areas.Blog.Controllers
{
    [Area("Blog")]
